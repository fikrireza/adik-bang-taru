          ...
          <div class="quick-actions_homepage">
            <ul class="quick-actions">
              <li class="bg_lo span12" style="margin-left:0px;">
                <a> <i class="icon-flag"></i> <i style="font-size:11px;">Terlibat dalam 5 program.</i></a>
              </li>
              <li class="bg_lg span12" style="margin-left:0px;">
                <a> <i class="icon-th-list"></i> <i style="font-size:11px;">Memiliki sebanyak 10 kegiatan.</i></a>
              </li>
            </ul>
          </div>
        </div>
